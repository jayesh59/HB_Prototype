...
class OdomInfo {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.localBundleModelTransforms = null;
      ...
      if (initObj.hasOwnProperty('localBundleModelTransforms')) {
        this.localBundleModelTransforms = initObj.localBundleModelTransforms
      }
      else {
        this.localBundleModelTransforms = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [localBundleModelTransforms]
    // Serialize the length for message field [localBundleModelTransforms]
    bufferOffset = _serializer.uint32(obj.localBundleModelTransforms.length, buffer, bufferOffset);
    obj.localBundleModelTransforms.forEach((val) => {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.localBundleModels[i] = sensor_msgs.msg.CameraInfo.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [localBundleModelTransforms]
    // Deserialize array length for message field [localBundleModelTransforms]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.localBundleModelTransforms = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.localBundleModelTransforms[i] = geometry_msgs.msg.Transform.deserialize(buffer, bufferOffset)
    }
  ...
  static getMessageSize(object) {
    ...
    length += 56 * object.localBundleModelTransforms.length;
  ...
  static md5sum() {
    ...
    return '1fa598d3d5fa4fd64473fc2a4cfbe1b3';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.localBundleModels !== undefined) {
      ...
      for (let i = 0; i < resolved.localBundleModels.length; ++i) {
        resolved.localBundleModels[i] = sensor_msgs.msg.CameraInfo.Resolve(msg.localBundleModels[i]);
      }
    }
    else {
    ...
    if (msg.localBundleModelTransforms !== undefined) {
      resolved.localBundleModelTransforms = new Array(msg.localBundleModelTransforms.length);
      for (let i = 0; i < resolved.localBundleModelTransforms.length; ++i) {
        resolved.localBundleModelTransforms[i] = geometry_msgs.msg.Transform.Resolve(msg.localBundleModelTransforms[i]);
      }
    }
    else {
      resolved.localBundleModelTransforms = []
    }
