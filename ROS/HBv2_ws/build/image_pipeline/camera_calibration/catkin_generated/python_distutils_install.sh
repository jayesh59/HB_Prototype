...
echo_and_run cd "/home/ubuntu20/HBv2_ws/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu20/HBv2_ws/src/image_pipeline/camera_calibration/setup.py" \
    egg_info --egg-base /home/ubuntu20/HBv2_ws/build/image_pipeline/camera_calibration \
    build --build-base "/home/ubuntu20/HBv2_ws/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
