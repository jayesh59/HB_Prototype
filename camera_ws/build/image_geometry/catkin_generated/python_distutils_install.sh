...
echo_and_run cd "/home/hb-jetson/camera_ws/src/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/hb-jetson/camera_ws/build/image_geometry \
    build --build-base "/home/hb-jetson/camera_ws/build/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
