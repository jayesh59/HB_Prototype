...
echo_and_run cd "/home/hb-jetson/camera_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hb-jetson/camera_ws/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/hb-jetson/camera_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
