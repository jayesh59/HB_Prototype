...
echo_and_run cd "/home/hb-jetson/camera_ws/src/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/hb-jetson/camera_ws/build/cv_bridge \
    build --build-base "/home/hb-jetson/camera_ws/build/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
