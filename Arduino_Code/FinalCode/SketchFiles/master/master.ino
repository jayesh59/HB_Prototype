...
//subscriber
void arm_pose_change(const hb_hw_interface::position_cmd &msg)
{
  float fi;
  float theta;
...
ros::Subscriber<hb_hw_interface::position_cmd> sub("/ros2arduino", &arm_pose_change);        

//publisher
hb_hw_interface::state_update state;
