...
if("TRUE" STREQUAL "TRUE")
  set(rosparam_shortcuts_SOURCE_PREFIX /home/ubuntu20/HBv2_ws/src/rosparam_shortcuts)
  set(rosparam_shortcuts_DEVEL_PREFIX /home/ubuntu20/HBv2_ws/devel)
  ...
  set(rosparam_shortcuts_INSTALL_PREFIX /home/ubuntu20/HBv2_ws/install)
...
if(NOT "/home/ubuntu20/HBv2_ws/src/rosparam_shortcuts/include;/usr/include/eigen3 " STREQUAL " ")
  set(rosparam_shortcuts_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu20/HBv2_ws/src/rosparam_shortcuts/include;/usr/include/eigen3")
  if(NOT "https://github.com/davetcoleman/rosparam_shortcuts/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'https://github.com/davetcoleman/rosparam_shortcuts/issues' and consider creating a ticket if the problem has not been reported yet.")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosparam_shortcuts' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu20/HBv2_ws/src/rosparam_shortcuts/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rosparam_shortcuts_EXPORTED_TARGETS ${${rosparam_shortcuts_dep}_EXPORTED_TARGETS})
endforeach()
