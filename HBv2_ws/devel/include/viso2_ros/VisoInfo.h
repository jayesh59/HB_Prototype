...
bool operator==(const ::viso2_ros::VisoInfo_<ContainerAllocator1> & lhs, const ::viso2_ros::VisoInfo_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.got_lost == rhs.got_lost &&
    lhs.change_reference_frame == rhs.change_reference_frame &&
    lhs.motion_estimate_valid == rhs.motion_estimate_valid &&
